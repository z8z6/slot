...
const Theme& Theme::UnrealEditor() {
  ...
  static const Theme theme{
      .Rect = {Color::ControlBackground, MarginStyle::Small,
               PaddingStyle::Small, 30.0f, 24.0f},
      .Text = {Color::Text, Color::TextMuted, Color::TextDisabled, 14.0f,
               20.0f},
      .ScrollBar = {Color::ControlPressed, Color::Divider, 10.0f, 24.0f},
      .Panel = {{Color::PanelBackground, MarginStyle::Medium,
                 PaddingStyle::Small, 240.0f, 160.0f},
