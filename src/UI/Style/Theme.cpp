...
const Theme& Theme::UnrealEditor() {
  ...
  static const Theme theme{
      .Rect = {Color::ControlBackground, Color::Border, 0.0f,
               MarginStyle::Small, PaddingStyle::Small, 30.0f, 24.0f, 4.0f},
      .Text = {Color::Text, Color::TextMuted, Color::TextDisabled, 14.0f,
               20.0f},
      // 16px 轨道扣除两侧 2px 内缩后仍有 12px 可见滑块，兼顾命中与层级感。
      .ScrollBar = {Color::ControlPressed, Color::Divider, 16.0f, 28.0f},
      .Panel = {{Color::PanelBackground, Color::Divider, 2.0f,
                 MarginStyle::Small, PaddingStyle::Small, 240.0f, 160.0f, 6.0f},
                Color::HeaderBackground, Color::Text, 34.0f,
