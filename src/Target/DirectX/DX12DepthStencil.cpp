...
void z8::DX12DepthStencil::InitBuffer()
{
  ...
  Render->CmdList->ResourceBarrier(1, &WriteBarrier);
}

void DX12DepthStencil::ClearBuffer()
{
  Render->CmdList->ClearDepthStencilView(Dpt, D3D12_CLEAR_FLAG_DEPTH | D3D12_CLEAR_FLAG_STENCIL, 1.0f, 0, 0, nullptr);
}
