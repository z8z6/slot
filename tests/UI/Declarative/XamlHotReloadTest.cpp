...
TEST(XamlHotReloadTest, LoadsProjectInterfaceFromAssetXml) {
  ...
  EXPECT_NE(layout.Find("left-browser"), nullptr);
  EXPECT_NE(layout.Find("content-browser"), nullptr);
  EXPECT_NE(layout.Find("world-outliner"), nullptr);
  ...
  const auto *leftBrowser =
      dynamic_cast<PanelGroupNode *>(layout.Find("left-browser"));
  const auto *details = dynamic_cast<PanelNode *>(layout.Find("details"));
  ASSERT_NE(toolbar, nullptr);
  ASSERT_NE(terminal, nullptr);
  ASSERT_NE(leftBrowser, nullptr);
